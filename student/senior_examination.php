...
<head>
        ...
        <title>PSIS | My Examinations</title>
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="panel panel-white">
                                    <div class="panel-body">
										   ...
										   $sql = "SELECT * FROM tbl_senior_examinations WHERE category = '$mycategory'";
                                        ...
                                        <tbody>';
                                           ...
                                           while($row = $result->fetch_assoc()) {
											   ...
											   $stl = '<a class="btn btn-success" href="take-senior-assessment.php?id='.$row['exam_id'].'">Take Examination</a>';
											   }else{
											   $st = '<p class="text-danger">INACTIVE</p>'; 
                                               $stl = '<a class="btn btn-danger disabled" href="#">Take Examination</a>';											   
											   }
                                          print '
										       <tr>
                                                <td>'.$row['exam_name'].'</td>
