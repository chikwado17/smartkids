...
$sql = "SELECT * FROM tbl_bank_records WHERE record_id = '$record_id'";
                           ...
                           <div class="col-md-6">
                            <div class="panel panel-white">
                                ...
                                <div class="alert alert-success" role="alert">
                                        ...
                                        <h1>PSIS Cares!!!</h1>
                                        Well done! You have finished this examination.
                                    </div>';								
								}
                              ...
                              <!-- <a class="btn btn-success" href="exam-review.php">Review Questions</a> -->
