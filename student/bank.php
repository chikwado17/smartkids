...
if ($retake_status == "1") {
$sql = "DELETE FROM tbl_bank_records WHERE student_id = '$myid' AND exam_id = '$exam_id'";
...
$sql = "SELECT * FROM tbl_bank_records WHERE student_id = '$myid'";
$result = $conn->query($sql);
                    ...
                    <div class="row">
                                <div class="panel panel-white">
                                    <div class="panel-body">
                                       ...
                                       <form action="pages/submit_bank.php" method="POST" name="quiz" id="quiz_form" >
								...
								<br><input style="float:right" onclick="return confirm('Are you sure you want to submit your assessment ?')" class="btn btn-success" name="submit" type="submit" value="Submit Assessment">
											</form>
...
//             var radioValue = $("input[name='<?php echo $qno ?>']:checked").val();
//             // var Ans = $("input[name='ran']:checked").val();
           
//                 alert("correct - " + radioValue);
