...
$record_found = 0;
$sql = "SELECT * FROM tbl_bank_exams WHERE exam_id = '$exam_id' AND category = '$mycategory'";
...
$sql = "SELECT * FROM tbl_bank_records WHERE student_id = '$myid' AND exam_id = '$exam_id'";
$result = $conn->query($sql);
                ...
                <div id="main-wrapper">
                    <div class="row col-md-12">
                        <div class="col-md-6">
                           ...
                           <div class="panel panel-white">
                                <div class="panel-heading">
                                    <h4 class="panel-title">Question Bank Properties</h4>
                                </div>
								...
								print '
                                 <div class="alert alert-success" role="alert">
                                  You are good to go.
									...
									'; ?>
									<a onclick="return confirm('Are you sure you want to begin ?')" class="btn btn-success" href="bank.php">Begin Assessment</a>
						...
						<div class="col-md-6">
                            <div class="panel panel-white">
                                <div class="panel-heading">
                                    <h3 class="panel-title">Question Bank History</h3>
                                </div>
                                <div class="panel-body">
                                <?php
								if ($record_found == "1") {
