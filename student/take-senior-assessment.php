...
$record_found = 0;
$sql = "SELECT * FROM tbl_senior_examinations WHERE exam_id = '$exam_id' AND category = '$mycategory'";
...
$sql = "SELECT * FROM tbl_senior_records WHERE student_id = '$myid' AND exam_id = '$exam_id'";
$result = $conn->query($sql);
            ...
            <div class="page-inner">
                <div class="page-title">
                    ...
                    <div class="page-breadcrumb">
                        <ol class="breadcrumb">
                            <li><a href="senior_examination.php">Examination</a></li>
                ...
                <div id="main-wrapper">
                    <div class="row col-md-12">
                                           ...
                                           <tbody>
                                               <tr>
											    ...
											    <tr>
                                                   <th scope="row">3</th>
                                                   <td>Duration</td>
                                                   <td><?php echo "$duration"; ?> <b>mins.</b></td>
                                               </tr>
						...
						<div class="col-md-6">
                            <div class="panel panel-white">
                                <div class="panel-heading">
                                    <h3 class="panel-title">Take Examination</h3>
                                </div>
                                <div class="panel-body">
								<?php
								if ($record_found == "1") {
								...
								print '
                                 <div class="alert alert-success" role="alert">
                                  You are good to go.
									...
									'; ?>
									<a onclick="return confirm('Are you sure you want to begin ?')" class="btn btn-success" href="senior_assessment.php">Retake Assessment</a>
								...
								print '
                                 <div class="alert alert-success" role="alert">
                                  You are good to go.
									...
									'; ?>
									<a onclick="return confirm('Are you sure you want to begin ?')" class="btn btn-success" href="senior_assessment.php">Begin Examination</a>
