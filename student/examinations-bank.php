        ...
        <main class="page-content content-wrap">
            ...
            <div class="page-inner">
                <div class="page-title">
                    <h3>My Question Bank Examinations</h3>
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="panel panel-white">
                                    <div class="panel-body">
										   ...
										   $sql = "SELECT * FROM tbl_bank_exams WHERE category = '$mycategory'";
                                        ...
                                        <tbody>';
                                           ...
                                           while($row = $result->fetch_assoc()) {
											   ...
											   $stl = '<a class="btn btn-success" href="take-bank.php?id='.$row['exam_id'].'">Take Assessment</a>';
											   }else{
