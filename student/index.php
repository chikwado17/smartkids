...
<head>
        ...
        <title>PSIS | Smartkids Student View</title>
                        ...
                        <div class="sidebar-profile">
                            <a href="javascript:void(0);" id="profile-menu-link">
                                ...
                                <div class="sidebar-profile-details">
                                    <span><?php echo "$myfname"; ?> <?php echo "$mylname"; ?><br><small>Smartkids</small></span>
                                </div>
                            </a>
                        </div>
                    </div>
					...
					<div class="container">
                        <div class="col-md-6 col-sm-6">
                            <div style="margin-top:100px">
                                <a href="student_live_quiz.php?id=<?php echo $myid ?>">
                                <button style="width:200px" class="btn btn-success btn-lg mybtn">Join Quiz</button>
                                </a>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 col-sm-6">
                            <div style="margin-top:100px"> 
                                <a href="student_live_quiz_90secs.php?id=<?php echo $myid ?>">
                                <button style="width:200px" class="btn btn-success btn-lg mybtn">Join 90sec Quiz</button>
                                </a> 
                            </div>
                        </div>
                    </div>
