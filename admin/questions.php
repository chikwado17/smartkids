                                    ...
                                    <div class="panel-body">
                                        <div role="tabpanel">
                                            ...
                                            <ul class="nav nav-tabs" role="tablist">
                                                ...
                                                <li role="presentation"><a href="#tab6" role="tab" data-toggle="tab">Add Theory Question</a></li>
                                            </ul>
                                            ...
                                            print '<option value="'.$row['exam_id'].'">'.$row['exam_name'].' - '.$row['category'].' - '.$row['subject'].'</option>';
                                            }
                                           } else {
