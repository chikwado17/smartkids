    ...
    <body <?php if ($ms == "1") { print 'onload="myFunction()"'; } ?>  class="page-header-fixed">
        ...
        <main class="page-content content-wrap">
            ...
            <div class="page-inner">
                ...
                <div id="main-wrapper" class="animated slideInLeft">
                    <div class="row">
                        <div class="col-md-12">
						<div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="panel panel-white">
                                    <div class="panel-body">
                                        <div role="tabpanel">
										   ...
										   <?php
										   include '../database/config.php';
										   $sql = "SELECT * FROM tbl_users WHERE role='student' AND groups_id = '0' ORDER BY first_name ASC";
                                           $result = $conn->query($sql);
                                        ...
                                        <tbody>';
                                          ...
                                          print '
										       <tr>
                                               <td><img src="data:image/jpeg;base64,'.base64_encode($photo).'" height="50" alt=""/> </td>
                                                ...
                                                <a href="join.php?id='.$user_id.'&&eid='.$exam_id.'">
                                                    <button class="btn btn-success btn-rounded  btn-sm" type="button"><i class="fa fa-recycle"></i> Join
                                                    </button>
                                                </a>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" placeholder="Enter class name" name="group" required autocomplete="off">
                                        </div>
