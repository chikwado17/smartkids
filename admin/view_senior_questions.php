                                    ...
                                    <div class="panel-body">
                                        <div class="tabs-below" role="tabpanel">
											...
											<div role="tabpanel" class="tab-pane active fade in" id="tab'.$qno.'">
											 ...
											 <hr>
											 <a  class="btn btn-twitter m-b-xs"href="edit_senior_questions.php?id='.$row['question_id'].'"><i class="fa fa-pencil"></i></a>
											 <a';?> onclick = "return confirm('Drop this question ?')" <?php print 'class="btn btn-youtube m-b-xs"href="pages/drop_senior_question.php?id='.$row['question_id'].'&eid='.$exam_id.'"><i class="fa fa-trash-o"></i></a>
											...
											<div role="tabpanel" class="tab-pane active fade in" id="tab'.$qno.'">
                                             <p><b>'.$qno.'.</b> '.$qs.'</p>
											 <p>A <input type="radio" name="'.$qno.'"  class="form-control" value='.$op1.'> '.$op1.'</p>
											 <p>B <input type="radio" name="'.$qno.'"  class="form-control" value='.$op2.'> '.$op2.'</p>
											 <p>C <input type="radio" name="'.$qno.'"  class="form-control" value='.$op3.'> '.$op3.'</p>
                                             <p>D <input type="radio" name="'.$qno.'"  class="form-control" value='.$op4.'> '.$op4.'</p>
                                             <p>E <input type="radio" name="'.$qno.'"  class="form-control" value='.$op5.'> '.$op5.'</p>
											 <hr>
											 <a  class="btn btn-twitter m-b-xs"href="edit_senior_questions.php?id='.$row['question_id'].'"><i class="fa fa-pencil"></i></a>
											 <a';?> onclick = "return confirm('Drop this question ?')" <?php print 'class="btn btn-youtube m-b-xs"href="pages/drop_senior_question.php?id='.$row['question_id'].'&eid='.$exam_id.'"><i class="fa fa-trash-o"></i></a>
                                             </div>
