...
$sql = "SELECT * FROM tbl_qt WHERE id = '$question_id'";
            ...
            <div class="page-sidebar sidebar">
                <div class="page-sidebar-inner slimscroll">
                    ...
                    <li><a href="students.php" class="waves-effect waves-button"><span class="menu-icon"><img width="40" src="../assets/icons/connection.svg"/></span><p>Students</p></a></li>
                        ...
                        <li><a href="examinations.php" class="waves-effect waves-button"><span class="menu-icon"><img width="40" src="../assets/icons/innovation.svg"/></span><p>Examinations</p></a></li>
                        <li><a href="results.php" class="waves-effect waves-button"><span class="menu-icon"><img width="40" src="../assets/icons/idea.svg"/></span><p>Exam Results</p></a></li>
                    </ul>
                </div>
            </div>
                                      ...
                                      <table class="table table-bordered">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <input type="text" value="'.$opt2.'" class="form-control" placeholder="Enter option 1" name="opt2" required autocomplete="off">
                                                </div>
												</td>
                                            ...
                                            <tr>
                                                ...
                                                <input type="text" value="'.$opt3.'" class="form-control" placeholder="Enter option 1" name="opt3" required autocomplete="off">
                                                </div>
												</td>
											...
											<tr>
                                                ...
                                                <input type="text" value="'.$opt4.'" class="form-control" placeholder="Enter option 1" name="opt4" required autocomplete="off">
                                                </div>
												</td>
