...
<head>
        ...
        <title>PSIS | Manage Results</title>
        ...
        <main class="page-content content-wrap">
            ...
            <div class="page-inner">
                <div class="page-title">
                    <h3>Manage Question Bank Results</h3>
                                          ...
                                          print '
										       <tr>
                                                ...
                                                <ul class="dropdown-menu" role="menu">
													...
													<li><a href="view-results-bank.php?eid='.$row['exam_id'].'">View Results</a></li>
									                <li><a href="summary-bank.php?eid='.$row['exam_id'].'">Short Summary</a></li>
