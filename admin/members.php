                                ...
                                <div class="panel panel-white">
                                    <div class="panel-body">
                                        <div role="tabpanel">
										   ...
										   <?php
										   include '../database/config.php';
										   $sql = "SELECT * FROM tbl_users WHERE groups_id='$exam_id' ORDER BY first_name ASC";
                                           $result = $conn->query($sql);
                                        ...
                                        <tbody>';
                                          ...
                                          print '
                                               ...
                                               <td><img src="data:image/jpeg;base64,'.base64_encode($photo).'" height="50" alt=""/> </td>
                                                ...
                                                <a href="unpair.php?id='.$user_id.'&&eid='.$exam_id.'">
                                                    <button class="btn btn-danger btn-rounded  btn-sm" type="button"><i class="fa fa-recycle"></i> Remove
                                                    </button>
                                                </a>
