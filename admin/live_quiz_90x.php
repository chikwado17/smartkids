...
<head>
	...
	<body <?php if ($ms == "1") { print 'onload="myFunction()"'; } ?>   class="page-header-fixed page-horizontal-bar" >
        ...
        <main class="page-content content-wrap">
            ...
            <div style="float: right;color:#151B54;font-size: 80px;" id="demo"></div>
                <div class="page-title">
                    ...
                    <div class="page-breadcrumb">
                        ...
                        <div class="col-lg-2" style="float: right;margin-top: 40px">
                            <a href="live_quiz_90x.php">
                                <img src="../assets/icons/148766.svg" class="img- animated zoomIn" height="50"> 
                            </a> 
                        </div>
                        
                        <!-- <div class="col-lg-2" style="float: right;color:#151B54;font-size: 60px;">
            ...
            <div class="col-lg-4" style="float: right;margin-top: 25px">
                ...
                $user_details = mysqli_query($conn, "select * from tbl_users where groups_id='$nw'");
...
<div class="row">
                ...
                <div class="col-lg-11 center-block" id="">
                    ...
                    <!-- <p><img src="../assets/icons/148772.svg" class="pull-right" height="70" id="nextp"> </p> -->
                    <div id="cip" style="margin: 25px;">
                        <?php
                         include '../database/config.php';
                         include 'includes/check_user.php'; 

                        $livesx1 = mysqli_query($conn, "SELECT * FROM tbl_group where status='1'");

                        while ($users_d1 = mysqli_fetch_array($livesx1)) {
                            $q_id = $users_d1['exam_id'];
                        }
                        ...
                        $ty = mysqli_query($conn, "SELECT * FROM tbl_qt WHERE exam_id='$q_id' AND status='0' order by rand() limit 1");
                        ...
                        while ($users_details1 = mysqli_fetch_array($ty)) {
                            ...
                            $pend1 = mysqli_query($conn, "update tbl_lives set live='$user_ide',user_answer=0, qa='$answer' where id='1'");
