        ...
        <main class="page-content content-wrap">
            ...
            <div class="page-sidebar sidebar">
                <div class="page-sidebar-inner slimscroll">
                    ...
                    <ul class="menu accordion-menu">
                        ...
                        <li><a href="senior_exam.php" class="waves-effect waves-button"><span class="menu-icon glyphicon glyphicon-book"></span><p>Senior Class Examinations</p></a></li>
            ...
            <div class="page-inner">
                <div class="page-title">
                    <h3>Manage Senior Examinations</h3>
                                ...
                                <div class="panel panel-white">
                                    <div class="panel-body">
                                        <div role="tabpanel">
										   ...
										   $sql = "SELECT * FROM tbl_senior_examinations";
                                        ...
                                        <tbody>';
                                           ...
                                           while($row = $result->fetch_assoc()) {
											   ...
											   $stl = '<a href="pages/make_se_in.php?id='.$row['exam_id'].'">Make Inactive</a>';
											   }else{
											   $st = '<p class="text-danger">INACTIVE</p>'; 
                                               $stl = '<a href="pages/make_se_ac.php?id='.$row['exam_id'].'">Make Active</a>';											   
											   }
                                          print '
										       <tr>
                                                <td>'.$row['exam_name'].'</td>
                                                ...
                                                <ul class="dropdown-menu" role="menu">
                                                    <li>'.$stl.'</li>
													<li><a href="edit_senior_exam.php?eid='.$row['exam_id'].'">Edit Exam</a></li>
													<li><a href="view_senior_questions.php?eid='.$row['exam_id'].'">View Questions</a></li>
													<li><a href="add_senior_exam.php?eid='.$row['exam_id'].'">Add Questions</a></li>
                                                    <li><a'; ?> onclick = "return confirm('Drop <?php echo $row['exam_name']; ?> ?')" <?php print ' href="pages/drop_se.php?id='.$row['exam_id'].'">Drop Exam</a></li>
                                                </ul>
                                            </div></td>
                                        ...
                                        Nothing was found in database.
                                         ...
                                         <form action="pages/add_senior_exam.php" method="POST">
