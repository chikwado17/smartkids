...
$sql = "SELECT * FROM tbl_group WHERE exam_id = '$exam_id'";
$result = $conn->query($sql);

if ($result->num_rows > 0) {

    while($row = $result->fetch_assoc()) {
    $exam_name =$row['group_name'];
    }
} else {
header("location:./");	
}
                                    ...
                                    <div class="panel-body">
                                        <div role="tabpanel">
                                            ...
                                            <div class="tab-content">
                                                ...
                                                <form enctype="multipart/form-data" action="pages/add_question.php?type=mc" method="POST">
                                      ...
                                      <table class="table table-bordered">
                                        ...
                                        <tbody>
											...
											<tr>
                                                ...
                                                <td><input type="radio" name="answer" value="4" required></td>
...
<div class="row">
    ...
    <div class="col-md-6" id="importFrm" style="display: none;">
        <form action="pages/import_examinations.php?type=mc" method="post" enctype="multipart/form-data">
