        ...
        <main class="page-content content-wrap">
            <div class="navbar">
                <div class="navbar-inner">
                    ...
                    <div class="logo-box">
                        <a href="./" class="logo-text"><span><img width="50px" src="./logo.png" alt=""></span></span></a>
                    </div>
            ...
            <div class="page-inner">
                ...
                <div id="main-wrapper" class="animated jackInTheBox">
                    <div class="row">
                        <div class="col-md-12">
						<div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="panel panel-white">
                                    <div class="panel-body">
										...
										<div class="form-group">
                                            ...
                                            <input type="text" value="<?php echo "$sdemail"; ?>" class="form-control" placeholder="Enter email address" name="email" required autocomplete="off">
                                        </div>
										
						
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">School Name</label>
                                            <input type="text" value="<?php echo $school_name ?>" class="form-control" placeholder="Enter student reg" name="school" required autocomplete="off">
                                        </div>
