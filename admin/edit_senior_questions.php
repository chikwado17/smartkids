...
$sql = "SELECT * FROM tbl_senior_questions WHERE question_id = '$question_id'";
...
<head>
        ...
        <title>PSIS | Edit Question</title>
						...
						<div class="row">   
                            <div class="col-md-12">
                                ...
                                <div class="panel panel-white">
								 ...
								 if ($type == "MC") {
									 print '
									  <form action="pages/update_senior_question.php?type=mc" method="POST">
												<div class="form-group">
                                                <label for="exampleInputEmail1">Question</label>
                                                <textarea name="question" id="editor" class="form-control ckeditor" required autocomplete="off">'.$question.'</textarea>
                                      ...
                                      <table class="table table-bordered">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <textarea name="opt1"  id="editor" class="form-control ckeditor" required autocomplete="off">'.$opt1.'</textarea>
                                            ...
                                            <tr>
                                                ...
                                                <textarea name="opt2"  id="editor" class="form-control ckeditor" required autocomplete="off">'.$opt2.'</textarea>
                                                </div>
												</td>
                                            ...
                                            <tr>
                                                ...
                                                <textarea name="opt3"  id="editor" class="form-control ckeditor" required autocomplete="off">'.$opt3.'</textarea>
                                                </div>
												</td>
											...
											<tr>
                                                ...
                                                <textarea name="opt4"  id="editor" class="form-control ckeditor" required autocomplete="off">'.$opt4.'</textarea>
                                                </div>
												</td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
												<div class="form-group">
                                                <label for="exampleInputEmail1">Option 5</label>
                                                <textarea name="opt5"  id="editor" class="form-control ckeditor" required autocomplete="off">'.$opt5.'</textarea>
                                                </div>
												</td>
                                                <td><input type="radio"'; if ($ans == "option5") { print ' checked="true" '; } print ' name="answer" value="option5" required></td>
									...
									print '
                                         <form action="pages/update_senior_question.php?type=fib" method="POST">
												<div class="form-group">
                                                <label for="exampleInputEmail1">Question</label>
