                                    ...
                                    <div class="panel-body">
                                        <div class="tabs-below" role="tabpanel">
											...
											<div role="tabpanel" class="tab-pane active fade in" id="tab'.$qno.'">
											 ...
											 <hr>
											 <a  class="btn btn-twitter m-b-xs"href="edit-question-bank.php?id='.$row['question_id'].'"><i class="fa fa-pencil"></i></a>
											 <a';?> onclick = "return confirm('Drop this question ?')" <?php print 'class="btn btn-youtube m-b-xs"href="pages/drop_question_bank.php?id='.$row['question_id'].'&eid='.$exam_id.'"><i class="fa fa-trash-o"></i></a>
