                                ...
                                <div class="panel panel-white">
                                    <div class="panel-body">
                                          ...
                                          print '
										       <tr>
                                                ...
                                                <ul class="dropdown-menu" role="menu">
                                                    <li>'.$stl.'</li>
                                                    <li><a'; ?> onclick = "return confirm('Drop <?php echo $row['name']; ?> ?')" <?php print ' href="pages/drop_dep.php?id='.$row['department_id'].'">Drop Class </a></li>
                                                </ul>
                                            </div></td>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" placeholder="Enter class name" name="department" required autocomplete="off">
                                        </div>
