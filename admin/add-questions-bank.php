...
$sql = "SELECT * FROM tbl_bank_exams WHERE exam_id = '$exam_id'";
                                    ...
                                    <div class="panel-body">
                                        <div role="tabpanel">
                                            ...
                                            <div class="tab-content">
                                                ...
                                                <form enctype="multipart/form-data" action="pages/add_question_bank.php?type=mc" method="POST">
												<div class="form-group">
                                                <label for="exampleInputEmail1">Question</label>
                                                <textarea name="question" id="editor" class="form-control ckeditor" required autocomplete="off"></textarea>
...
<div class="row">
    ...
    <div class="col-md-6" id="importFrm" style="display: none;">
        <form action="pages/import_bank_questions.php?type=mc" method="post" enctype="multipart/form-data">
