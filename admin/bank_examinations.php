...
<head>
        ...
        <title>PSIS | Manage Examinations</title>
            ...
            <div class="page-sidebar sidebar">
                <div class="page-sidebar-inner slimscroll">
                    ...
                    <ul class="menu accordion-menu">
                        ...
                        <li><a href="bank_examinations.php" class="waves-effect waves-button"><span class="menu-icon glyphicon glyphicon-book"></span><p>Question Bank</p></a></li>
                                    ...
                                    <div class="panel-body">
                                        <div role="tabpanel">
                                            ...
                                            <ul class="nav nav-tabs" role="tablist">
                                                ...
                                                <li role="presentation" class="active"><a href="#tab5" role="tab" data-toggle="tab">Question Bank</a></li>
                                                <li role="presentation"><a href="#tab6" role="tab" data-toggle="tab">Add Question Bank</a></li>										
										   ...
										   $sql = "SELECT * FROM tbl_bank_exams";
                                        ...
                                        <tbody>';
                                           ...
                                           while($row = $result->fetch_assoc()) {
											   ...
											   $stl = '<a href="pages/make_ba_in.php?id='.$row['exam_id'].'">Make Inactive</a>';
											   }else{
											   $st = '<p class="text-danger">INACTIVE</p>'; 
                                               $stl = '<a href="pages/make_ba_ac.php?id='.$row['exam_id'].'">Make Active</a>';											   
											   }
                                          print '
										       <tr>
                                                <td>'.$row['exam_name'].'</td>
                                                ...
                                                <ul class="dropdown-menu" role="menu">
                                                    <li>'.$stl.'</li>
													<li><a href="edit-bank.php?eid='.$row['exam_id'].'">Edit Exam</a></li>
													<li><a href="view-questions-bank.php?eid='.$row['exam_id'].'">View Questions</a></li>
                                                    <li><a href="add-questions-bank.php?eid='.$row['exam_id'].'">Add Questions</a></li>
                                                    <li><a'; ?> onclick = "return confirm('Drop <?php echo $row['exam_name']; ?> ?')" <?php print ' href="pages/drop_ba.php?id='.$row['exam_id'].'">Drop Exam</a></li>
                                                </ul>
                                            </div></td>
                                        ...
                                        Nothing was found in database.
                                         ...
                                         <form action="pages/add_bank.php" method="POST">
										<div class="form-group">
                                            <label for="exampleInputEmail1">Question Type</label>
                                            <input type="text" class="form-control" placeholder="Enter exam type" name="exam" required autocomplete="off">
                                        </div>
										<div class="form-group">
                                            <label for="exampleInputEmail1">Question Duration (Minutes)</label>
										...
										<div class="form-group">
                                            ...
                                            <input type="text" class="form-control" placeholder="Enter passmark" name="passmark" required autocomplete="off">
                                        </div>
    ...
    <div class="form-group">
        ...
        <input type="text" class="form-control" placeholder="e.g 1st term, 2nd term or 3rd term" name="section" required autocomplete="off">
    </div>      
            ...
            <div class="form-group">                        
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" placeholder="Enter exam date e.g MM/DD/YYYY" name="date" required autocomplete="off">
                </div>                               
            </div>	
