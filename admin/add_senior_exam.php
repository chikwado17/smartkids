...
$sql = "SELECT * FROM tbl_senior_examinations WHERE exam_id = '$exam_id'";
...
<head>
        ...
        <title>PSIS | Add Questions</title>
                                    ...
                                    <div class="panel-body">
                                        <div role="tabpanel">
                                            ...
                                            <div class="tab-content">
                                                ...
                                                <form enctype="multipart/form-data" action="pages/add_senior_question.php?type=mc" method="POST">
												<div class="form-group">
                                                <label for="exampleInputEmail1">Question</label>
                                                <p><textarea name="question" id="editor" class="form-control ckeditor" required autocomplete="off"></textarea></p>
                                      ...
                                      <table class="table table-bordered">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <input type="text" class="form-control" placeholder="Enter option 5" name="opt5" required autocomplete="off">
                                                </div>
												</td>
                                                <td><input type="radio" name="answer" value="option5" required></td>
                                
                                            </tr>
                                        </tbody>
                                    </table>

                                    <span class="text-danger" style="font-weight: bold">Question Diagram</span>
                                    <input type="file" name="image" accept="image/*" autocomplete="off"><br><br>
...
<div class="row">
    ...
    <div class="col-md-6 head">
        <div class="float-right">
            <a href="javascript:void(0);" class="btn btn-success" onclick="formToggle('importFrm');"><i class="plus"></i> Import Questions</a>
        </div>
    </div>
    ...
    <div class="col-md-6" id="importFrm" style="display: none;">
        <form action="pages/importData.php?type=mc" method="post" enctype="multipart/form-data">
            ...
            <input type="submit" class="btn btn-primary" name="importSubmit" value="upload">
                                         ...
                                         <form action="pages/add_senior_question.php?type=fib" method="POST">
												<div class="form-group">
                                                <label for="exampleInputEmail1">Question</label>
