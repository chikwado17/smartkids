...
$sql = "SELECT * FROM tbl_senior_examinations WHERE exam_name = '$exam' AND subject = '$subject' AND category = '$category'";
...
$sql = "INSERT INTO tbl_senior_examinations (exam_id, category, subject, exam_name, date, duration, passmark, re_exam, terms, section)
VALUES ('$exam_id', '$category', '$subject', '$exam', '$date', '$duration', '$passmark', '$attempts', '$terms', '$section')";

if ($conn->query($sql) === TRUE) {
header("location:../senior_exam.php?rp=2932");
} else {
header("location:../senior_exam.php?rp=7788");
}
