...
$sql = "SELECT * FROM tbl_qt WHERE exam_id = '$examid' AND question = '$question' AND id != '$question_id'";
...
$sql = "UPDATE tbl_qt SET question='$question', option1='$opt1', option2='$opt2', option3='$opt3', option4='$opt4', answer='$answer' WHERE id='$question_id'";
...
$sql = "UPDATE tbl_qt SET question='$question', answer='$answer' WHERE id='$question_id'";
