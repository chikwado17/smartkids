...
<head>
        ...
        <title>SMARTKIDS | Manage Students</title>
                                ...
                                <div class="panel panel-white">
                                    <div class="panel-body">
                                          ...
                                          print '
										       <tr>
                                                ...
                                                <ul class="dropdown-menu" role="menu">
                                                    <li>'.$stl.'</li>
													<li><a href="edit-student.php?sid='.$row['user_id'].'"><span><img src="../assets/icons/1141771.svg" height="20"></span> Edit Student</a></li>
													<li><a href="view-student.php?sid='.$row['user_id'].'"><span><img src="../assets/icons/settings.svg" height="20"></span> View Student</a></li>
                                                    <li><a'; ?> onclick = "return confirm('Drop <?php echo $row['first_name']; ?> ?')" <?php print ' href="pages/drop_sd.php?id='.$row['user_id'].'"><span><img src="../assets/icons/desk.svg" height="20"></span> Drop Student</a></li>
                                                </ul>
                                            </div></td>
										...
										<div class="form-group">
                                            ...
                                            <input type="text" class="form-control" placeholder="Enter student reg" name="email" required autocomplete="off">
                                        </div>
										
								
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">School Name</label>
                                            <input type="text" class="form-control" placeholder="Enter student reg" name="school" required autocomplete="off">
                                        </div>
