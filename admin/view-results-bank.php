...
$exam_id = $_GET['eid'];
$sql = "SELECT * FROM tbl_bank_records WHERE exam_id = '$exam_id'";
                                          ...
                                          print '
                                               ...
                                               <td>'.$row['date'].'</td>
                                                ...
                                                <ul class="dropdown-menu" role="menu">
													...
													<li><a'; ?> onclick = "return confirm('Reactivate exam for <?php echo $row['student_name']; ?> ?')" <?php print ' href="pages/re-activate-bank.php?rid='.$row['record_id'].'&eid='.$exam_id.'">Re-activate</a></li>
