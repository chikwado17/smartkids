...
$exam_id = $_GET['eid'];
$sql = "SELECT * FROM tbl_senior_records WHERE exam_id = '$exam_id'";
...
<head>
        ...
        <title>PSIS | <?php echo "$exam_name" ?> Results</title>
        ...
        <main class="page-content content-wrap">
            ...
            <div class="page-inner">
                                          ...
                                          print '
										       <tr>
                                                ...
                                                <ul class="dropdown-menu" role="menu">
													...
													<li><a'; ?> onclick = "return confirm('Reactivate exam for <?php echo $row['student_name']; ?> ?')" <?php print ' href="pages/re-activate-ss.php?rid='.$row['record_id'].'&eid='.$exam_id.'">Re-activate</a></li>
                ...
                <form action="ss.php" method="post">
                    <input type="submit" name="download_result" class="btn btn-primary" value="Download Result">                          
                </form>
            </div>
            </div>
        </main>
